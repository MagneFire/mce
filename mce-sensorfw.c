...
static const char *sfw_sample_wrist_repr(const sfw_sample_wrist_t *self);
...
static const char *
sfw_sample_wrist_repr(const sfw_sample_wrist_t *self)
{
    static char buf[64];
    snprintf(buf, sizeof buf,
             "time=%"PRIu64" state=%s",
             self->wrist_timestamp,
             self->wrist_tilted ? "tilted" : "untilted");
...
>>>>>>> 7bd4cfb ([mce-sensorfw] Implement sensor-test mode for mce. JB#41369)
